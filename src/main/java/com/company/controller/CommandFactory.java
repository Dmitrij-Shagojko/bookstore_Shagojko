...
public class CommandFactory {
    ...
    private CommandFactory() {
        ...
        BookService bookService = new BookService(new BookDAOImpl(DataSource.INSTANCE));
        UserService userService = new UserService(new UserDAOImpl(DataSource.INSTANCE));
